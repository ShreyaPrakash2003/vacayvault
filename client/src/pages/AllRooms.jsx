...
import ChatBotPopup from '../components/Chatpopup.jsx';
...
const AllRooms = () => {
  const { rooms, fetchRooms } = UserData();
    ...
    <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div>
            ...
            <div className="md:w-1/2 flex flex-col gap-2">
              ...
              <div className="flex flex-wrap items-center mt-3 mb-6 gap-4">
                {room.amenities.map((item, i) => (
                  <div key={i} className="flex items-center gap-2 px-3 py-2 rounded-lg bg-[#F5F5FF]/70">
        ...
        {filteredRooms.length === 0 && (
          <p className="mt-12 text-gray-500">No matching rooms found.</p>
        )}
      </div>
